...
- FTP с демонстрационными версиями Master Scada 4D [(ссылка)](https://demo.mps-soft.ru/demo/MasterSCADA_4D_Free/).
- Официальный [сайт](https://masterscada.ru/download4) с демонстрационными версиями Master Scada 4D.
- FTP с лицензионными версиями Master Scada 4D [(ссылка)](https://download.mps-soft.ru/demo/). ==Требуется авторизация.==
